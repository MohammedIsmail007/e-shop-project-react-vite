...
function Product(props) {
  ...
  return (
    <>
      ...
      <div className=" w-72 p-4 mt-3 bg-transparent text-white rounded-lg shadow-2xl bg-gradient-to-br from-fuchsia-600 to-amber-200  transform hover:scale-105 bg-opacity-75 transition-transform duration-300 ease-in-out">
        <img
